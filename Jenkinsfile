...
node{
   ...
   /* stage ("check sock ")
    ...
    {
        ansiblePlaybook credentialsId: 'jenkinAnsibleCred', disableHostKeyChecking: true, installation: 'ansible', inventory: '/etc/ansible/hosts', playbook: '/etc/ansible/ansible-playbook.yaml', vaultTmpPath: ''
    }
}
